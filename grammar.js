module.exports = grammar({
  ...
  rules: {
    ...
    _ins_sse2_pentium4: ($) =>
      choice(
        /mov(apd|ntpd|hpd|lpd|upd|mskpd|dq2q|q2dq|ntdq)/,
        /(add|div|max|min|mul|sqrt|sub)(pd|sd)/,
        /(andn?|x?or|cmp|shuf|unpck[hl])pd/,
        /u?comisd/,
        /cvtt?(dq|pd|pi|ps|sd|si|ss)2(dq|pd|pi|ps|sd|si|ss)/,
        /paddus[bw]/,
        "pmuludq",
        "punpckhbw",
        "maskmovdqu",
